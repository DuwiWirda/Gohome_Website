...
@section('container')
    ...
    <main id="main" class="main">
        <div class="pagetitle" style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <a href="{{ route('kamar.refresh') }}" class="btn btn-success button p-2" style="margin-left: 10px;"><i
                    class="bi bi-arrow-clockwise"></i></a>
            <a href="{{ route('kamar.add') }}" class="btn btn-success button p-2" style="margin-left: 10px;"><i
                        ...
                        <tbody>
                            @foreach ($kamar as $index => $kamar)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kamar.destroy', ['id_kamar' => $kamar->id_kamar]) }}"
